      ...
      <div className={styles.container}>
        <div className={styles.left}>
          <div className={styles.imageContainer}>
            <img src={avineshImage} alt="Ujjwal Jindal" />
        ...
        <div className={styles.right}>
          ...
          <p ref={descriptionRef} className={styles.description}>
            ...
            taking on challenges. Originally from Bahraich, Uttar Pradesh,
          ...
          <div className={styles.infoContainer}>
            <div className={styles.info}>
              <h2>Name</h2>
              <p ref={nameRef}>Avinesh Pratap Singh</p>
            </div>
            <div className={styles.info}>
              <h2>Education</h2>
              <p ref={educationRef}>
            ...
            <div className={styles.info}>
              <h2>Email</h2>
              <p ref={emailRef}>pratapavinesh2003@gmail.com</p>
            </div>
            <div className={styles.info}>
              <h2>Phone</h2>
              <p ref={phoneRef}>+91 6307978382</p>
            </div>
          </div>
        </div>
      </div>
